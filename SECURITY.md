...
The following table shows which versions of `pdf_to_png` are currently being supported with security updates.
...
We deeply appreciate the efforts of security researchers and contributors who help us improve the security of `pdf_to_png`.
